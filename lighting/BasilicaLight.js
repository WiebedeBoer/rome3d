...
//lighting
var hemilight = new THREE.HemisphereLight( 0xfffff0, 0x101020, 0.4 );
...
var light11 = new THREE.PointLight(0xfffff0, 0.6, 80);
light11.position.set(-149,40,225);
scene.add(light11);
var light12 = new THREE.PointLight(0xfffff0, 0.6, 80);
light12.position.set(-149,40,175);
scene.add(light12);
var light13 = new THREE.PointLight(0xfffff0, 0.6, 80);
light13.position.set(-149,40,125);
scene.add(light13);
var light14 = new THREE.PointLight(0xfffff0, 0.6, 80);
light14.position.set(-149,40,75);
scene.add(light14);
var light15 = new THREE.PointLight(0xfffff0, 0.6, 80);
light15.position.set(-149,40,25);
scene.add(light15);
var light16 = new THREE.PointLight(0xfffff0, 0.6, 80);
light16.position.set(-149,40,-25);
scene.add(light16);
var light17 = new THREE.PointLight(0xfffff0, 0.6, 80);
light17.position.set(-149,40,-75);
scene.add(light17);
var light18 = new THREE.PointLight(0xfffff0, 0.6, 80);
light18.position.set(-149,40,-125);
scene.add(light18);
var light19 = new THREE.PointLight(0xfffff0, 0.6, 80);
light19.position.set(-149,40,-175);
scene.add(light19);
var light20 = new THREE.PointLight(0xfffff0, 0.6, 80);
