...
var gun = new Coin(228,6,16); //shop 23,20
scene.add(gun);
var gun2 = new Coin(127,6,-161); //shop 22,18
scene.add(gun2);
var gun3 = new Coin(-457,6,-1433); //shop 15,4
scene.add(gun3);
var gun4 = new Coin(1150,6,-1428); //shop 33,4
scene.add(gun4);
var gun5 = new Coin(-919,6,822); //shop 10,30
scene.add(gun5);
